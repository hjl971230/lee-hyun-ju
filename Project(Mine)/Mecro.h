...
enum DIRECTION
{
	...
	DIRECTION_UP_ONE = 8,
	DIRECTION_DOWN_ONE = 9,
	DIRECTION_LEFT_ONE = 10,
	DIRECTION_RIGHT_ONE = 11,
	DIRECTION_LEFTUP_ONE = 12,
	DIRECTION_LEFTDOWN_ONE = 13,
	DIRECTION_RIGHTUP_ONE = 14,
	DIRECTION_RIGHTDOWN_ONE = 15,
	DIRECTION_ALL = 16,
	DIRECTION_ALL_ONE = 17
};